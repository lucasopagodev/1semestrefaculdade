...
public class Janela extends JFrame{
	...
	private JLabel lblAcessorios = new JLabel("Acessórios");
	
	private JCheckBox chkRadio = new JCheckBox("Rádio");
	private JCheckBox chkRodaDeLigaLeve = new JCheckBox("Roda Liga Leve");
	private JCheckBox chkCameraDeRe = new JCheckBox("Câmera de Ré");
	private JCheckBox chkFarolDeNeon = new JCheckBox("Farol de Neon");
	
	private JButton btnConfirmar = new JButton("Confirmar");
	private JButton btnSair = new JButton("Sair");
	
	private JLabel lblCombustivel = new JLabel("Combustível");
	...
	public Janela() {
		setTitle("Janela de Configuração de Veículos");
		setSize(800, 600);
