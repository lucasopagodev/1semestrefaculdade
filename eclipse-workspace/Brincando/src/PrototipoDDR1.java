...
public class PrototipoDDR1 extends JFrame {
	...
	public PrototipoDDR1() {
		...
		txtNome.setBounds(20, 40, 350, 20);
		...
		txtEmail.setBounds(20, 160, 200, 20);
		objPainel.add(txtEmail);
		
		lblCelular.setBounds(20, 180, 200, 20);
		objPainel.add(lblCelular);
		
		txtCelular.setBounds(20, 200, 200, 20);
		objPainel.add(txtCelular);
