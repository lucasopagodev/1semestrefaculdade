...
public class JanelaPrincipalCal extends JFrame {
	...
	public JanelaPrincipalCal() {
		...
		btnSomar.setBounds(18, 230, 100, 30);
		btnSomar.addActionListener(new AcaoSomar(txtNr1, txtNr2, txtResultado));
		objPainel.add(btnSomar);
		
		btnSubtrair.setText("Subtrair");
		btnSubtrair.setBounds(118, 230, 100, 30);
		btnSubtrair.addActionListener(new AcaoSubtrair(txtNr1, txtNr2, txtResultado));
		objPainel.add(btnSubtrair);
		
		btnMultiplicar.setText("Multiplicar");
		btnMultiplicar.setBounds(218, 230, 100, 30);
		btnMultiplicar.addActionListener(new AcaoMultiplicar(txtNr1, txtNr2, txtResultado));
		objPainel.add(btnMultiplicar);
		
		btnDividir.setText("Dividir");
		btnDividir.setBounds(318, 230, 100, 30);
		btnDividir.addActionListener(new AcaoDividir(txtNr1, txtNr2, txtResultado));
