...
public class AcaoGravar implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "BURRO!!! Digite um número!");
			return;
		}
		
		if (txaDescricao.getText().equals("")) {
			JOptionPane.showMessageDialog(null, "BURRO!!! Escreva algo na descricão!");
			return;
		}
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "BURRO!!! Digite algum preço!");
			return;
		}
